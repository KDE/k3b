...
K3bDvdResize::K3bDvdResize(K3bDvdCodecData *data, QWidget *parent, const char *name ) : QGroupBox(parent,name) {
    m_data = data;
    setupGui();
}
...
void K3bDvdResize::initView(){
    m_orginalAspect = m_data->getAspectRatioValue();
    updateView();
}

void K3bDvdResize::updateView(){
...
void K3bDvdResize::slotResizeChanged( int value ){
...
void K3bDvdResize::slotHeightChanged( int index ){
