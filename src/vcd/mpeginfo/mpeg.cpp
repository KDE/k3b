...
void mpeg::PrintInfos() {
  ...
  if (MpegType == mpeg_AUDIO){
		...
		switch (Audio->mode) {
			case 0: dbg.append("  Stereo,"); break;
			case 1: dbg.append("  Joint Stereo: ");
					  if (Audio->layer==1 || Audio->layer==2) {
						  switch (Audio->modext) {
							  case 0: dbg.append("(Intensity stereo on bands 4-31/32)\n"); break;
							  case 1: dbg.append("(Intensity stereo on bands 8-31/32)\n"); break;
							  case 2: dbg.append("(Intensity stereo on bands 12-31/32)\n"); break;
							  case 3: dbg.append("(Intensity stereo on bands 16-31/32)\n"); break;
						  }
					  } else {
						  //mp3
						  switch (Audio->modext){
							  case 0: dbg.append("(Intensity stereo off, M/S stereo off)\n"); break;
							  case 1: dbg.append("(Intensity stereo on, M/S stereo off)\n"); break;
							  case 2: dbg.append("(Intensity stereo off, M/S stereo on)\n"); break;
							  case 3: dbg.append("(Intensity stereo on, M/S stereo on)\n"); break;
						  }
					  }
					  break;
			case 2: dbg.append("  Dual Channel,"); break;
			case 3: dbg.append("  Mono,"); break;
		}

		switch (Audio->emphasis_index){
			case 0: dbg.append("  No emphasis,"); break;
			case 1: dbg.append("  Emphasis: 50/15 microsecs,"); break;
			case 2: dbg.append("  Emphasis Unknown,"); break;
			case 3: dbg.append("  Emphasis CCITT J 17,"); break;
		}

		if (Audio->copyright) dbg.append("  (c),");
		if (Audio->original)
      dbg.append("  original\n");
		else
      dbg.append("  copy\n");
    ...
    dbg.append(QString("  Estimated Duration: %1\n").arg(HMS));
		...
		switch(Video->aspect_ratio) {
			case 0: dbg.append("  Invalid aspect ratio (forbidden)\n"); break;
			case 1: dbg.append("  Aspect ratio 1/1 (VGA)\n"); break;
			case 2: dbg.append("  Aspect ratio 4/3 (TV)\n"); break;
			case 3: dbg.append("  Aspect ratio 16/9 (large TV)\n"); break;
			case 4: dbg.append("  Aspect ratio 2.21/1 (Cinema)\n"); break;
			default: dbg.append("  Invalid Aspect ratio (reserved)\n");
        ...
        dbg.append("  Interlaced, chroma format: ");
			switch (SExt->chroma_format) {
				case 1 : dbg.append("4:2:0\n"); break;
				case 2 : dbg.append("4:2:2\n"); break;
				case 3 : dbg.append("4:4:4\n"); break;
			}
		}
		if (DExt){
			switch (DExt->video_format) {
				case 0 : dbg.append("  Video Format: Component\n"); break;
				case 1 : dbg.append("  Video Format: PAL\n"); break;
				case 2 : dbg.append("  Video Format: NTSC\n"); break;
				case 3 : dbg.append("  Video Format: SECAM\n"); break;
				case 4 : dbg.append("  Video Format: MAC\n"); break;
				case 5 : dbg.append("  Video Format: Unspecified\n"); break;
			}
	...
	if (MpegType == mpeg_SYSTEM ) {
        ...
        if (Audio->bitrate)
          ...
          dbg.append(QString("  free bitrate %1 Hz\n").arg(Audio->sampling_rate));
				...
				switch (Audio->emphasis_index){
					case 0: dbg.append("  No emphasis\n"); break;
					case 1: dbg.append("  Emphasis: 50/15 microsecs\n"); break;
					case 2: dbg.append("  Emphasis Unknown\n"); break;
					case 3: dbg.append("  Emphasis CCITT J 17\n"); break;
				}
			}
		}
    kdDebug() << dbg << endl;
	...
	while (off > 0) {
		...
		switch (mark) {
			...
			case 0x00 :
				...
				break;
			case 0xba: kdDebug() << QString("            PACK    [%1]").arg(off) << endl; break;
			case VideoPkt: kdDebug() << QString("            Video   [%1]").arg(off) << endl; break;
			case AudioPkt: kdDebug() << QString("            Audio   [%1]").arg(off) << endl; break;
			case PaddingPkt: kdDebug() << QString("            Padding [%1]").arg(off) << endl; break;
  ...
  QString dbg;
	for(int i = 0; i < n_progs; i++) {
		...
		while (current != 0) {
			...
			switch (current->type) {
				case 0: dbg.append("reserved"); break;
				case 1: dbg.append("MPEG 1 video");break;
				case 2: dbg.append("MPEG 2 video");break;
				case 3: dbg.append("MPEG 1 audio");break;
				case 4: dbg.append("MPEG 2 audio");break;
				case 5: dbg.append("MPEG 2 private section");break;
				case 6: dbg.append("MPEG 2 PES with private data");break;
				case 7: dbg.append("MHEG");break;
				case 8: dbg.append("DSM_CC");break;
				case 9: dbg.append("Private data");break;
				default: if (current->type <0x80)
