    ...
    m_doc( pDoc )
{
  ...
  KAction* burnAction = new KAction( i18n("&Burn"), "cdburn", CTRL + Qt::Key_B, this, SLOT(slotBurn()),
				     actionCollection(), "project_burn");
  burnAction->setToolTip( i18n("Open the burn dialog for the current project") );
  KAction* propAction = new KAction( i18n("&Properties"), "edit", CTRL + Qt::Key_P, this, SLOT(slotProperties()),
