...
class K3bAudioTrackTRMLookupDialog : public KDialogBase, public K3bJobHandler
{
  Q_OBJECT
 ...
 public:
  ...
  int waitForMedia( K3bDevice::Device*,
		    int, int, const QString& ) { return 0; }
  
  /**
   * unused
   */
  bool questionYesNo( const QString&, const QString& ) { return false; }
