...
#ifndef kiotreeitem_h
#define kiotreeitem_h
 ...
 * but they should all be KioTreeItems, for the event handling in KioTree.
 */
class KioTreeItem : public QListViewItem
{
public:
    // Create an item under another one
    KioTreeItem( KioTreeItem *parentItem, KioTreeTopLevelItem *topLevelItem );

    void initItem( KioTreeTopLevelItem *topLevelItem );
...
/*     virtual void rename() {} */
    ...
    KioTreeTopLevelItem * topLevelItem() const { return m_topLevelItem; }

    // returns the module associated to our toplevel item
    KioTreeModule * module() const;
...
protected:
    ...
    KioTreeItem( KioTree *parent, KioTreeTopLevelItem *topLevelItem );
