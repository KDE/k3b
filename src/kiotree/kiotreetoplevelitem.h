...
#ifndef kiotreetoplevelitem_h
#define kiotreetoplevelitem_h
 ...
 */
class KioTreeTopLevelItem : public KioTreeItem
{
public:
    /**
     ...
     */
    KioTreeTopLevelItem( KioTree *parent, KioTreeModule * module, const QString & path )
        : KioTreeItem(parent, 0L), m_module(module), m_path(path), m_bTopLevelGroup(false) { init(); }
     ...
     * @param path the path to the desktop file that was the reason for creating this item
     */
    KioTreeTopLevelItem( KioTreeItem *parentItem, KioTreeModule * module, const QString & path )
        : KioTreeItem( parentItem, 0L), m_module(module), m_path(path), m_bTopLevelGroup(false) { init(); }
...
/*     void rename( const QString & name ); // do the actual renaming */
    ...
    KioTreeModule *module() const { return m_module; }
