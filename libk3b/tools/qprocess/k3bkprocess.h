 ...
 **/
class LIBK3B_EXPORT K3bKProcess : public K3bQProcess
{
    Q_OBJECT
    Q_DECLARE_PRIVATE(K3bKProcess)

public:
    // we reuse the KProcess enum to make future transition easier
#if 0
    /**
    ...
    enum OutputChannelMode {
        SeparateChannels = ::QProcess::SeparateChannels,
            /**< Standard output and standard error are handled by K3bKProcess
     ...
     * @return a reference to this K3bKProcess
     */
    K3bKProcess &operator<<(const QString& arg);
     ...
     * @return a reference to this K3bKProcess
     */
    K3bKProcess &operator<<(const QStringList& args);
     ...
     *
     * If K3bKProcess determines that the command does not really need a
     ...
     *
     * The K3bKProcess object may be re-used immediately after calling this
     * function.
     *
...
protected:
     ...
     * @internal
     */
    K3bKProcess(K3bKProcessPrivate *d, QObject *parent);

    /**
     * @internal
     */
    K3bKProcessPrivate * const d_ptr;

private:
    // hide those
    using K3bQProcess::setReadChannelMode;
    using K3bQProcess::readChannelMode;
    using K3bQProcess::setProcessChannelMode;
    using K3bQProcess::processChannelMode;
